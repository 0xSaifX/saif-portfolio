    ...
    <header className="fixed top-0 left-0 w-full bg-zinc-950/80 backdrop-blur border-b border-zinc-800 z-50">
      <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 text-sm text-zinc-200">
          <a href="#projects" className="hover:text-emerald-400 text-zinc-200 no-underline transition">
            Projects
          </a>
          <a href="#skills" className="hover:text-emerald-400 text-zinc-200 no-underline transition">
            Skills
          </a>
          <a href="#contact" className="hover:text-emerald-400 text-zinc-200 no-underline transition">
            Contact
          </a>
